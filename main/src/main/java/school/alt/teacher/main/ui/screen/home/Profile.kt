...
import school.alt.teacher.main.ui.compose.item.Bar
...
//                Log.d("profile LaunchedEffect", "result : ${profileViewModel.userInfo.value?.user?.name}")
//                name.value = profileViewModel.userInfo.value?.user?.name
//            profileViewModel.getUserImage()
//            }
...
//    LaunchedEffect(profileViewModel.userInfo) {
//        Log.d("profile LaunchedEffect", "result : ${profileViewModel.userInfo.value?.user?.name}")
//        name.value = profileViewModel.userInfo.value?.user?.name
//    }
