...
import school.alt.teacher.main.ui.compose.button.Button1
...
fun HomeScreen(
    ...
    val meal by homeViewModel.meal.observeAsState(initial = listOf("", "", ""))
    ...
    val productionState by storeViewModel.productionState.collectAsStateWithLifecycle(
        NetworkResultState()
    )
        ...
        Column(Modifier.padding(top = 12.dp, bottom = 12.dp)) {
            Row(
                ...
                IcAdd(
                    ...
                    }, contentDescription = "", tint = main2, size = 21.dp
                )
            }
